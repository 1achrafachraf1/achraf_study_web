document.addEventListener("DOMContentLoaded", () => {
    ...
    (function initAIChat(){
        ...
        async function askGroq(userText){
            ...
            const messages=[
                {role:"system", content:"أنت مساعد تعليمي ذكي فمنصة دراسية مغربية موجهة لتلاميذ الأولى باكالوريا، فمواد الرياضيات والفيزياء والكيمياء وعلوم الحياة والأرض. جاوب بالدارجة المغربية أو العربية الفصحى بطريقة واضحة ومختصرة ومشجعة، وساعد التلميذ يفهم الدرس أو يحل التمرين خطوة بخطوة."},
